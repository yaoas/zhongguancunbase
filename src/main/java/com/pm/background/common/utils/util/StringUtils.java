 ...
 * 8、replace 替换字符串
 *
 * 9、isNotEmpty   字符串是否为空(不trim并判断)
 *
 * 10、isNotBlank   字符串是否为空(trim后判断)  对于业务逻辑上 用一般认为 空格也相当没有输入  那么  我们最常使用的方法 应该为 isNotBlank这个方法
 *
 * 10、getRandomString   获取指定长度的随机字符串
 */
